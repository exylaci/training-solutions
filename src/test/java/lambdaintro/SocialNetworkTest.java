...
public class SocialNetworkTest {
    ...
    public void testApplyToSelectedMembers() {
        ...
        assertEquals("Dear Jane Doe!",
                socialNetwork.findMembersBy(m -> m.getName().equals("Jane Doe")).get(0).getMessages().get(0));
        assertEquals("Dear Janet Doe!",
                socialNetwork.findMembersBy(m -> m.getName().equals("Janet Doe")).get(0).getMessages().get(0));
        assertEquals(0,
                socialNetwork.findMembersBy(m -> m.getName().equals("Jenifer Doe")).get(0).getMessages().size());
    }
