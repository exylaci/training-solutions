...
class LongestWordTest {
    ...
    void testWords() {
        ...
        assertEquals(expected, longestWord.findLongestWord("src/test/resources/exambemenetivizsga/test-files/test1.txt"));
    }

    @Test
    void testNumbersDoubleSpaces() {
        String expected = "000000000000000001";
        assertEquals(expected, longestWord.findLongestWord("src/test/resources/exambemenetivizsga/test-files/test2.txt"));
    }
    ...
    void testWordsMultipleCorrect() {
        ...
        String actual = longestWord.findLongestWord("src/test/resources/exambemenetivizsga/test-files/test3.txt");
    ...
    void testSingleWordFile() {
        String expected = "42";
        assertEquals(expected, longestWord.findLongestWord("src/test/resources/exambemenetivizsga/test-files/test4.txt"));
    }
